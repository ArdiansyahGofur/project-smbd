...
<head>
    ...
    <title>List Mobil Tersedia</title>
...
<div class="container">
    ...
    <div class="row">
        ...
        // Panggil prosedur tersedia
        $sql = "CALL tersedia(@message)";
        ...
        if ($result) {
            ...
            // Tampilkan pesan atau detail mobil yang tersedia
            if ($message == 'Tidak ada mobil yang tersedia.') {
                echo "<p>$message</p>";
            } else {
                // Ambil hasil dari prosedur tersedia setelah menyelesaikan proses sebelumnya
                $result = $koneksi->query("SELECT id_mobil, no_plat, merk, tahun_mobil, harga_sewa, status_mobil, gambar FROM mobil WHERE status_mobil = 'Tersedia'");
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "</table>";
                    echo "<a href='peminjaman.php?id_mobil={$row['id_mobil']}' class='btn btn-primary'>Sewa</a>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                }
