...
<head>
    ...
    <link rel="stylesheet" href="css/rincian_tidak_tersedia.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            <?php
            // Query untuk mengambil data dari view mobil_tidak_tersedia
            $query = "SELECT * FROM mobil_tidak_tersedia";
